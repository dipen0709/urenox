...
/* jQuery.validator.addMethod("name", function(value, element){
    return this.optional(element)||/^[a-z]+$/i.test(value);
}, jQuery.validator.messages.name);
 */
...
}, "Password must be 8 characters with uppercase letters, lowercase letters and at least one number.");

jQuery.validator.addMethod("CONFIRMPASSWORD", function(value, element){
    return this.optional(element)||/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(.*){8,}$/.test(value);
}, "Confirm Password must be 8 characters with uppercase letters, lowercase letters and at least one number.");
